...
# 0.00576089852027 b1500 a1.075pi/4 ?
# 0.0026280081882 b1500 a1.079pi/4
# 0.000108329130473 b1480 a1.081pi/4
...
if close_speed_factor > 1:
    if raw_input("Sure you want to save?(y/N)") == 'y':
        save = True
    else:
        save = False
if save:
